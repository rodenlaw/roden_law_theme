...
<section class="hero">
    ...
    <div class="hero-inner">
        <div class="hero-content">
            ...
            <p class="hero-sub">Truck accidents cause catastrophic injuries &mdash; and trucking companies have armies of lawyers working to limit what they pay you. Roden Law has recovered over <?php echo esc_html( $stats['recovered'] ); ?> for injury victims<?php echo $city_is_custom ? ' across ' . esc_html( $city ) . ' and ' . esc_html( $default_city ) : ''; ?> and we know how to take on the trucking industry.</p>
        ...
        <div class="hero-form-card">
            ...
            <form id="leadForm" action="#" method="POST" novalidate>
                ...
                <label class="form-consent" style="display:flex;align-items:flex-start;gap:10px;margin-bottom:12px;cursor:pointer;">
                    ...
                    <span style="font-size:11px;color:#94a3b8;line-height:1.5;">I hereby expressly consent to receive automated communications including calls, texts, emails, and/or prerecorded messages. By submitting this form, you agree to our <a href="<?php echo esc_url( home_url( '/privacy-policy/' ) ); ?>" target="_blank" rel="noopener noreferrer" style="color:#f5a623;text-decoration:underline;">Terms &amp; Privacy Policy</a>.</span>
                </label>
