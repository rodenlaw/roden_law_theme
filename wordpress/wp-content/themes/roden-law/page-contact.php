    ...
    <section class="section section-alt" id="offices">
        <div class="site-container">
            <div class="section-header">
                ...
                <p><?php printf( esc_html__( '%d offices across Georgia and South Carolina', 'roden-law' ), count( $firm['offices'] ) ); ?></p>
            </div>
            ...
            <div class="locations-grid">
                <?php foreach ( $firm['offices'] as $key => $office ) : ?>
                    <div class="card location-card">
                        ...
                        <a href="<?php echo esc_url( roden_lang_home_url( null, '/locations/' . $office['state_slug'] . '/' . sanitize_title( $office['market_name'] ) . '/' ) ); ?>" aria-label="<?php echo esc_attr( sprintf( /* translators: %s: office market name. */ __( 'View %s office', 'roden-law' ), $office['market_name'] ) ); ?>"
                           class="location-link">
