<?php
/**
 * Seeder: medical-malpractice-lawyers × Columbia, SC intersection page (ENRICH)
 *
 * UPDATES the existing /medical-malpractice-lawyers/columbia-sc/ page in place
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-medmal-columbia.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching medical-malpractice-lawyers × Columbia, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents patients harmed by medical negligence in Columbia, South Carolina and throughout the Midlands</strong> — Lexington, Irmo, West Columbia, Cayce, and Forest Acres. We handle every medical malpractice claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18032192816">(803) 219-2816</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Columbia Medical Malpractice Claim</h2>
...
<li><strong>Trial-ready</strong> — we prepare every claim for the Richland County Circuit Court, which is what moves hospital insurers to pay full value.</li>
</ul>

<h2>Columbia Medical Malpractice Cases We Handle</h2>
<p>Columbia is the Midlands' medical hub, anchored by Prisma Health Richland and the region's major hospital systems, and the cases our attorneys see most often include:</p>
<ul>
<li><strong>Surgical errors and anesthesia mistakes</strong> at Prisma Health Richland and other large Midlands hospitals.</li>
...
<h2>South Carolina Medical Malpractice Law: What Columbia Patients Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Medical Malpractice Lawyers in Columbia, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best medical malpractice lawyers in Columbia, SC?',
		'answer'   => 'Roden Law is a leading medical malpractice firm serving Columbia and the Midlands, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our Columbia office at 1545 Sumter Street handles every case on a contingency fee basis — no fee unless we win — and retains medical experts from the outset. Call (803) 219-2816 for a free consultation.',
	),
	array(
	...
	array(
		'question' => 'Do I need an expert before suing for malpractice in Columbia?',
	...
	array(
		'question' => 'How much does a Columbia medical malpractice lawyer cost?',
		'answer'   => 'Roden Law handles Columbia medical malpractice cases on a contingency fee basis. You pay no attorney fees and no upfront costs — including the cost of the medical experts needed to build your case — and we are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
	array(
		'question' => 'What counts as medical malpractice at a Columbia hospital?',
		'answer'   => 'Medical malpractice occurs when a provider fails to meet the accepted standard of care of a reasonably prudent practitioner in the same specialty, and that failure causes harm. Common examples at institutions such as Prisma Health Richland include surgical errors, misdiagnosis, birth injuries, medication mistakes, and hospital-acquired infections.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /medical-malpractice-lawyers/columbia-sc/ — post ID {$post_id}" );
