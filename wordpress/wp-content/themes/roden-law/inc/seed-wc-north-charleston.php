<?php
/**
 * Seeder: workers-compensation-lawyers × North Charleston, SC intersection page (ENRICH)
 *
 ...
 * first intro, "why Roden Law", local industry/claim drivers (Boeing/port/
 * warehouse/Palmetto Commerce), and WC-specific SC deadline nuances.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-wc-north-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching workers-compensation-lawyers × North Charleston, SC...' );
...
<h2>Common North Charleston Workplace Injuries We Handle</h2>
<p>North Charleston concentrates some of the state's highest-injury industries, each with its own claim pattern:</p>
<ul>
<li><strong>Aerospace and manufacturing injuries</strong> — repetitive-motion, machinery, and fall injuries at Boeing and its supplier and contractor operations.</li>
<li><strong>Warehouse and logistics injuries</strong> — lifting injuries, forklift incidents, and struck-by injuries across the Palmetto Commerce Parkway and Rivers Avenue (US-52/78) distribution corridors and the port terminals.</li>
<li><strong>Retail and hospitality injuries</strong> — slips, falls, and lifting injuries at Tanger Outlets and the Rivers Avenue retail strip.</li>
<li><strong>Construction and roadwork injuries</strong> — falls, struck-by, and equipment injuries around the busy I-26/I-526 interchange and ongoing tri-county development.</li>
</ul>
...
<p>Temporary total disability pays <strong>66⅔% of your average weekly wage</strong>, subject to a statewide maximum that South Carolina resets each year. Permanent injuries are valued under the <strong>body-part schedule in S.C. Code § 42-9-30</strong> based on the impairment rating you receive at maximum medical improvement (MMI). Because your employer's insurer generally directs your medical care and chooses your physician, that doctor's rating heavily influences your recovery — which is exactly where your own attorney matters most.</p>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => "Workers' Compensation Lawyers in North Charleston, SC",
...
$faqs = array(
	array(
		'question' => "Who are the best workers' comp lawyers in North Charleston, SC?",
		'answer'   => "Roden Law is a leading workers' compensation firm serving North Charleston and the tri-county area, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our North Charleston office on Spruill Avenue handles every claim on a contingency fee basis — no fee unless we win — and you work directly with your attorney. Call (843) 612-6561 for a free consultation.",
	),
	array(
	...
	array(
		'question' => 'I was hurt at Boeing or a North Charleston warehouse — do I have a workers\' comp claim?',
		'answer'   => 'Very likely yes. Most factory, aerospace, and warehouse workers in South Carolina are covered by workers\' compensation, and it is a no-fault system, so you do not need to prove your employer did anything wrong. Roden Law can review your injury and make sure your claim is filed correctly. Call (843) 612-6561 for a free review.',
	),
	array(
	...
	array(
		'question' => 'Can I pick my own doctor for a North Charleston workers\' comp injury?',
	...
	array(
		'question' => 'What if my North Charleston workers\' comp claim is denied or my checks stop?',
		'answer'   => 'A denial or benefit cutoff is not the end — you can request a hearing before the South Carolina Workers\' Compensation Commission. Roden Law regularly takes disputed claims to the Commission to restore medical care and wage benefits. Call (843) 612-6561 for a free review.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /workers-compensation-lawyers/north-charleston-sc/ — post ID {$post_id}" );
