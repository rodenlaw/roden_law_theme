<?php
/**
 * Seeder: dog-bite-lawyers × North Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /dog-bite-lawyers/north-charleston-sc/ in place
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-dogbite-north-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching dog-bite-lawyers × North Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents dog-bite and animal-attack victims across North Charleston, South Carolina</strong> and the surrounding Charleston County communities. South Carolina is a <strong>strict-liability state</strong>: a dog owner is liable for a bite or attack even if the dog never showed aggression before. We take every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18436126561">(843) 612-6561</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a North Charleston Dog Bite Claim</h2>
<p>Most dog-bite recoveries come from the owner's homeowner's or renter's insurance, and adjusters routinely argue the victim provoked the animal or was somewhere they should not have been. What separates Roden Law is direct attorney involvement and the investigation needed to defeat those defenses. Our attorneys serve North Charleston and the whole Charleston County area, with cases heard in the Charleston County Circuit Court.</p>
<ul>
...
<h2>Dog Attacks in the North Charleston Area</h2>
<p>Serious animal attacks happen across North Charleston — at homes and rental properties, in apartment complexes, on sidewalks, and during visits to a neighbor's or friend's property. Children are frequent victims and often suffer facial injuries because of their height relative to the animal. Because North Charleston has a large renter population, identifying the responsible owner and the correct insurance policy is often the first and most important step in the case.</p>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Dog Bite Lawyers in North Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best dog bite lawyers in North Charleston, SC?',
	...
	array(
		...
		'answer'   => 'In most cases the dog owner\'s homeowner\'s or renter\'s insurance provides the recovery. Roden Law investigates ownership and identifies every applicable policy, which is often the most important step in a North Charleston dog-attack case, especially with rental properties.',
	),
	array(
...
WP_CLI::success( "Enriched /dog-bite-lawyers/north-charleston-sc/ — post ID {$post_id}" );
