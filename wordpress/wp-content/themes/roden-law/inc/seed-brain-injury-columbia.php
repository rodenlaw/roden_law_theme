<?php
/**
 * Seeder: brain-injury-lawyers × Columbia, SC intersection page (ENRICH)
 *
 * UPDATES the existing /brain-injury-lawyers/columbia-sc/ page in place with
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-brain-injury-columbia.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching brain-injury-lawyers × Columbia, SC...' );
...
<h2>How Columbia Brain Injuries Happen</h2>
<p>The TBI cases our Columbia attorneys handle most often arise from:</p>
<ul>
<li><strong>Car and truck crashes</strong> on the I-20/I-26/I-77 "Malfunction Junction" interchange and its Carolina Crossroads work zones — the leading cause of serious head trauma.</li>
<li><strong>Falls</strong> — from heights, on stairs, and on unsafe premises.</li>
<li><strong>Pedestrian and bicycle collisions</strong> on Midlands roads and in the USC and Five Points area.</li>
<li><strong>Workplace and construction incidents</strong> on Midlands job sites and roadwork projects.</li>
<li><strong>Medical negligence</strong>, including oxygen-deprivation and surgical injuries.</li>
</ul>

<h2>South Carolina Brain Injury Law: What Columbia Victims Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Brain Injury Lawyers in Columbia, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best brain injury lawyers in Columbia, SC?',
		'answer'   => 'Roden Law is a leading brain injury firm serving Columbia and the Midlands, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our Columbia office at 1545 Sumter Street handles every case on a contingency fee basis — no fee unless we win — and works with life-care planners and medical experts. Call (803) 219-2816 for a free consultation.',
	),
	array(
	...
	array(
		'question' => 'What are the symptoms of a traumatic brain injury after a Columbia accident?',
	...
	array(
		'question' => 'How much is a Columbia brain injury case worth?',
	...
	array(
		'question' => 'How much does a Columbia brain injury lawyer cost?',
		'answer'   => 'Roden Law handles Columbia brain injury cases on a contingency fee basis. You pay no attorney fees and no upfront costs — we advance the cost of the experts and life-care planning needed to build your case — and we are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /brain-injury-lawyers/columbia-sc/ — post ID {$post_id}" );
