<?php
/**
 * Seeder: product-liability-lawyers × North Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /product-liability-lawyers/north-charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-product-north-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching product-liability-lawyers × North Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents people injured by dangerous and defective products in North Charleston, South Carolina</strong> and across the Lowcountry. With Boeing and aerospace manufacturing, the port, and a dense industrial and distribution base, North Charleston produces and moves an enormous volume of equipment and consumer goods — and when a product fails, the manufacturer, distributor, and retailer can all be held responsible. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18436126561">(843) 612-6561</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a North Charleston Product Liability Claim</h2>
...
<h2>North Charleston Product Liability Cases We Handle</h2>
<p>North Charleston's industrial and freight economy shapes the defective-product cases our attorneys see most:</p>
<ul>
<li><strong>Industrial and port equipment</strong> — machinery, forklifts, lifts, and equipment failures at manufacturing, warehouse, and maritime sites along Palmetto Commerce Parkway and the port.</li>
<li><strong>Auto and tire defects</strong> — defective airbags, tire failures, and vehicle component defects tied to crashes at the I-26 / I-526 junction and area highways.</li>
...
<li><strong>Recreational and boating products</strong> — defective watercraft and marine equipment used on area waterways.</li>
</ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Product Liability Lawyers in North Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'What if I was hurt by defective equipment at work in North Charleston?',
		'answer'   => 'You may have both a workers\' compensation claim against your employer and a separate product liability claim against the manufacturer or seller of the defective machine. With North Charleston\'s manufacturing, port, and warehouse work, these third-party product claims are common. Roden Law can evaluate both paths.',
	),
	array(
		'question' => 'How much does a North Charleston product liability lawyer cost?',
		'answer'   => 'Roden Law handles North Charleston product liability cases on a contingency fee basis. You pay no attorney fees and no upfront costs — including the cost of the engineering experts needed to build your case — and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /product-liability-lawyers/north-charleston-sc/ — post ID {$post_id}" );
