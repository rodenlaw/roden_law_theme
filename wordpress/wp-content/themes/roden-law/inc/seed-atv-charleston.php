<?php
/**
 * Seeder: atv-side-by-side-accident-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /atv-side-by-side-accident-lawyers/charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-atv-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching atv-side-by-side-accident-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents ATV and side-by-side (UTV) crash victims across Charleston, South Carolina</strong> and the Lowcountry — Mount Pleasant, Summerville, Goose Creek, and the surrounding rural areas. Rollovers, ejections, and passenger injuries — often to children — make off-road vehicle crashes uniquely dangerous. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston ATV or UTV Claim</h2>
<p>Off-road vehicle cases turn on how the crash happened — a rollover caused by a defect, an operator's negligence, or a hazard on someone's land — and insurers push to blame the rider. What separates Roden Law is the investigation and expert work needed to determine whether the vehicle, the operator, or a property owner is responsible. Our Charleston office at 127 King Street, Suite 200 sits on the peninsula minutes from the Charleston County Circuit Court.</p>
<ul>
...
<h2>Off-Road Crash Risks in the Charleston Area</h2>
<p>ATVs and side-by-sides are used across the rural and semi-rural Lowcountry outside the city — on farmland, hunting property, wooded trails, and large residential lots. Rollovers on uneven terrain, ejections when riders are not secured, and passenger injuries (especially to children carried on machines not designed for them) are the most serious patterns we see. Because these vehicles lack the crash protection of a car, even a low-speed tip-over can cause catastrophic injuries.</p>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'ATV & Side-by-Side Accident Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best ATV accident lawyers in Charleston, SC?',
	...
	array(
		...
		'answer'   => 'South Carolina regulates all-terrain vehicles under S.C. Code Title 50, Chapter 26, which includes safety requirements such as helmet and eye protection and age-related restrictions on minor operators. A violation of these safety rules can be relevant evidence in an injury case. Roden Law can review how the specific rules apply to your crash.',
	),
	array(
		'question' => 'My child was hurt as an ATV passenger — do we have a case?',
		'answer'   => 'Often yes. Children are frequently injured as passengers on machines not designed to carry them. A parent can bring a claim on the child\'s behalf, and South Carolina places no cap on compensatory damages in ordinary injury cases, so future care and long-term needs can be pursued in full.',
	),
	array(
...
WP_CLI::success( "Enriched /atv-side-by-side-accident-lawyers/charleston-sc/ — post ID {$post_id}" );
