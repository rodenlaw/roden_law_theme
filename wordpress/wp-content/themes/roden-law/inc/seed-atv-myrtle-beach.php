<?php
/**
 * Seeder: atv-side-by-side-accident-lawyers × Myrtle Beach, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /atv-side-by-side-accident-lawyers/myrtle-beach-sc/ in
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-atv-myrtle-beach.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching atv-side-by-side-accident-lawyers × Myrtle Beach, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents ATV and side-by-side (UTV) crash victims across Myrtle Beach and the Grand Strand</strong> — Murrells Inlet, Conway, Surfside Beach, Pawleys Island, and Georgetown. Rollovers, ejections, and passenger injuries — often to children — make off-road vehicle crashes uniquely dangerous. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18436121980">(843) 612-1980</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Grand Strand ATV or UTV Claim</h2>
<p>Off-road vehicle cases turn on how the crash happened — a rollover caused by a defect, an operator's negligence, or a hazard on someone's land — and insurers push to blame the rider. What separates Roden Law is the investigation and expert work needed to determine whether the vehicle, the operator, or a property owner is responsible. Grand Strand cases are handled through the Horry County court in Conway, and we also serve clients in neighboring Georgetown County.</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'ATV & Side-by-Side Accident Lawyers in Myrtle Beach, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best ATV accident lawyers in Myrtle Beach, SC?',
	...
	array(
		'question' => 'Can I sue if a defect caused my ATV or side-by-side to roll over?',
	...
	array(
		'question' => 'My child was hurt as a side-by-side passenger — do we have a case?',
		'answer'   => 'Often yes. Children are frequently injured as passengers, and even purpose-built side-by-sides can eject an unsecured child in a rollover. A parent can bring a claim on the child\'s behalf, and South Carolina places no cap on compensatory damages in ordinary injury cases, so future care and long-term needs can be pursued in full.',
	),
	array(
...
WP_CLI::success( "Enriched /atv-side-by-side-accident-lawyers/myrtle-beach-sc/ — post ID {$post_id}" );
