<?php
/**
 * Seeder: nursing-home-abuse-lawyers × North Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /nursing-home-abuse-lawyers/north-charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-nursinghome-north-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching nursing-home-abuse-lawyers × North Charleston, SC...' );
...
<h2>North Charleston Nursing Home Harms We Handle</h2>
<p>The tri-county area's senior population fills numerous long-term-care and assisted-living facilities, and the harms our attorneys see most include:</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Nursing Home Abuse Lawyers in North Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'How much does a North Charleston nursing home abuse lawyer cost?',
		'answer'   => 'Roden Law handles North Charleston nursing home abuse and neglect cases on a contingency fee basis. You pay no attorney fees and no upfront costs, and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /nursing-home-abuse-lawyers/north-charleston-sc/ — post ID {$post_id}" );
