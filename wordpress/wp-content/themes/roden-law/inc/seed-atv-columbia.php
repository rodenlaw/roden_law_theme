<?php
/**
 * Seeder: atv-side-by-side-accident-lawyers × Columbia, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /atv-side-by-side-accident-lawyers/columbia-sc/ in
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-atv-columbia.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching atv-side-by-side-accident-lawyers × Columbia, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents ATV and side-by-side (UTV) crash victims across Columbia, South Carolina</strong> and the Midlands — Lexington, Irmo, West Columbia, Cayce, and the surrounding rural counties. Rollovers, ejections, and passenger injuries — often to children — make off-road vehicle crashes uniquely dangerous. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18032192816">(803) 219-2816</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Columbia ATV or UTV Claim</h2>
<p>Off-road vehicle cases turn on how the crash happened — a rollover caused by a defect, an operator's negligence, or a hazard on someone's land — and insurers push to blame the rider. What separates Roden Law is the investigation and expert work needed to determine whether the vehicle, the operator, or a property owner is responsible. Our Columbia office at 1545 Sumter Street, Suite B sits in the downtown corridor minutes from the Richland County Circuit Court.</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'ATV & Side-by-Side Accident Lawyers in Columbia, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best ATV accident lawyers in Columbia, SC?',
...
WP_CLI::success( "Enriched /atv-side-by-side-accident-lawyers/columbia-sc/ — post ID {$post_id}" );
