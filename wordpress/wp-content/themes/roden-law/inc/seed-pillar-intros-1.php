...
,
    ...
    'slip-and-fall-lawyers' => array(
        'negligence' => <<<'EOT'
Slip-and-fall is governed by **premises liability** doctrine, which keys liability to the visitor's status — invitee (highest duty), licensee (limited duty), or trespasser (minimal duty). {{GA}}In Georgia, an invitee must prove the owner had **actual or constructive knowledge** of the hazard and that the plaintiff lacked equal knowledge — the controlling test from *Robinson v. Kroger Co.*, 268 Ga. 735 (1997). {{/GA}}{{SC}}In South Carolina, an invitee must prove the owner had **actual or constructive knowledge** of the hazard and that the plaintiff lacked equal knowledge, under *Wintersteen v. Food Lion, Inc.*, 344 S.C. 32 (2001). {{/SC}}Hazard documentation (incident reports, surveillance video, prior cleaning logs) is decisive evidence in {market_name}-area cases.
EOT
,
        'compensation' => <<<'EOT'
...
,
        'compensation' => <<<'EOT'
**There is no recovery for pain and suffering in workers' compensation** — only statutory benefits: medical (uncapped, related), temporary total disability (TTD) at 2/3 of average weekly wage subject to a state maximum, permanent partial disability per the body-part schedule, and (for fatalities) death benefits to surviving dependents. {{GA}}**Georgia's TTD maximum is set by statute and adjusted periodically** (O.C.G.A. § 34-9-261, § 34-9-265). {{/GA}}{{SC}}**South Carolina TTD tracks the statewide average weekly wage**, with permanent partial disability scheduled by body part under S.C. Code § 42-9-30. {{/SC}}Third-party tort recoveries fund the noneconomic damages workers' comp does not cover.
EOT
,
    ),
