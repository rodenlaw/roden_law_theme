<?php
/**
 * Seeder: brain-injury-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing /brain-injury-lawyers/charleston-sc/ page in place with
 ...
 * context, and TBI-specific SC nuances (life-care plans, no cap) — no dup.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-brain-injury-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching brain-injury-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents people who have suffered a traumatic brain injury in Charleston, South Carolina and throughout the Lowcountry</strong> — Mount Pleasant, Summerville, Goose Creek, and the peninsula. Brain injuries are often catastrophic and permanent, and we handle every claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston Brain Injury Claim</h2>
<p>A traumatic brain injury (TBI) can permanently change a person's ability to work, think, and care for themselves — and full-value cases require medical experts, life-care planners, and vocational economists, not just a demand letter. What separates Roden Law is direct attorney involvement and the resources to build that proof. Our office at 127 King Street sits on the Charleston peninsula, minutes from the Charleston County Circuit Court and MUSC and Roper, so investigation, records, and filings happen without delay.</p>
<ul>
...
<h2>How Charleston Brain Injuries Happen</h2>
<p>The TBI cases our Charleston attorneys handle most often arise from:</p>
<ul>
<li><strong>Car and truck crashes</strong> on I-526, the Ravenel Bridge, US-17, and I-26 — the leading cause of serious head trauma.</li>
<li><strong>Falls</strong> — from heights, on stairs, and on unsafe premises.</li>
<li><strong>Pedestrian and bicycle collisions</strong> on the peninsula and Mount Pleasant corridors.</li>
<li><strong>Workplace, construction, and port incidents.</strong></li>
<li><strong>Medical negligence</strong>, including oxygen-deprivation and surgical injuries.</li>
</ul>

<h2>South Carolina Brain Injury Law: What Charleston Victims Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Brain Injury Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best brain injury lawyers in Charleston, SC?',
		'answer'   => 'Roden Law is a leading brain injury firm serving Charleston and the Lowcountry, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our Charleston office at 127 King Street handles every case on a contingency fee basis — no fee unless we win — and works with life-care planners and medical experts. Call (843) 790-8999 for a free consultation.',
	),
	array(
	...
	array(
		'question' => 'What are the symptoms of a traumatic brain injury after a Charleston accident?',
	...
	array(
		'question' => 'How much is a Charleston brain injury case worth?',
	...
	array(
		'question' => 'How much does a Charleston brain injury lawyer cost?',
		'answer'   => 'Roden Law handles Charleston brain injury cases on a contingency fee basis. You pay no attorney fees and no upfront costs — we advance the cost of the experts and life-care planning needed to build your case — and we are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /brain-injury-lawyers/charleston-sc/ — post ID {$post_id}" );
