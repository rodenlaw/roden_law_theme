...
$pillar_intros = array(
    ...
    'nursing-home-abuse-lawyers' => array(
        'negligence' => <<<'EOT'
Nursing home claims sound in **professional negligence** (sometimes med-mal-adjacent), ordinary negligence, statutory violations, and — for intentional misconduct — battery and elder-abuse torts. The federal **Nursing Home Reform Act, 42 U.S.C. § 1395i-3 / § 1396r**, and CMS regulations at **42 C.F.R. Part 483** establish baseline standards of care that support negligence-per-se theories. **Pre-dispute arbitration agreements** are routine and heavily contested under *Marmet Health Care Center v. Brown*, 565 U.S. 530 (2012). {{GA}}Georgia treats most nursing-home claims as professional negligence requiring an expert affidavit under O.C.G.A. § 9-11-9.1; {{/GA}}{{SC}}South Carolina treats most nursing-home claims as professional negligence requiring a Notice of Intent to File Suit and an expert affidavit under S.C. Code § 15-79-125; {{/SC}}ordinary-negligence theories (e.g., understaffing, falls without medical judgment) sometimes escape that requirement.
EOT
,
        'compensation' => <<<'EOT'
Damages include past and future medical care, pain and suffering, and — critically — **elder-abuse statutory damages and punitives**. {{SC}}South Carolina's **Omnibus Adult Protection Act (S.C. Code § 43-35-5 et seq.)** informs the standard of care. South Carolina's $350,000 / $1.05M noneconomic cap (S.C. Code § 15-32-220) applies if the claim is characterized as medical malpractice; **ordinary-negligence and intentional-tort theories escape the cap**, which is a key strategic decision in pleading. {{/SC}}{{GA}}Georgia's **Disabled Adults and Elder Persons Protection Act (O.C.G.A. § 30-5-1 et seq.)** informs the standard of care. {{/GA}} Wrongful-death claims under {state_full} law often substantially exceed the underlying nursing-home claim value.
EOT
,
    ),
    ...
    'premises-liability-lawyers' => array(
        'negligence' => <<<'EOT'
The duty owed by a property owner turns on the **entrant's legal status**: invitee (ordinary care), licensee (avoid willful/wanton injury), trespasser (no willful/wanton injury). {{GA}}Georgia codifies these duties at **O.C.G.A. §§ 51-3-1 through 51-3-3**. {{/GA}}{{SC}}South Carolina follows common-law classifications refined in *Sims v. Giles*, 343 S.C. 708 (2000). {{/SC}}**Negligent security** (third-party criminal acts) is a major sub-area: {{GA}}in Georgia, *CVS Pharmacy, Inc. v. Carmichael*, 316 Ga. 718 (2023), confirmed the totality-of-the-circumstances test for foreseeability. {{/GA}}{{SC}}South Carolina applies a balancing test from *Bass v. Gopal, Inc.*, 395 S.C. 129 (2011). {{/SC}}Filing deadline: {sol_years} years under {sol_cite}.
EOT
,
        'compensation' => <<<'EOT'
...
,
    ...
    'bicycle-accident-lawyers' => array(
        'negligence' => <<<'EOT'
Cyclists have the **same rights and duties as motor-vehicle operators** {{GA}}under O.C.G.A. § 40-6-290 to -298{{/GA}}{{SC}}under S.C. Code § 56-5-3410 to -3450{{/SC}}. A **3-foot passing rule** applies to motorists overtaking cyclists ({{GA}}O.C.G.A. § 40-6-56{{/GA}}{{SC}}S.C. Code § 56-5-3435{{/SC}}), violation of which supports negligence per se. Helmet laws are limited — {{GA}}Georgia requires helmets only for riders under 16 (O.C.G.A. § 40-6-296). {{/GA}}{{SC}}South Carolina has no statewide helmet requirement. {{/SC}}Door-zone collisions, right-hook turns, and intersection failure-to-yield are the most common claim patterns. Filing deadline: {sol_years} years under {sol_cite}.
EOT
,
        'compensation' => <<<'EOT'
...
,
    ...
    'atv-side-by-side-accident-lawyers' => array(
        'negligence' => <<<'EOT'
ATVs and side-by-sides (UTVs) are generally **not legal on public roads** in either state except in limited circumstances. {{GA}}In Georgia, **O.C.G.A. § 40-7-1 et seq.** governs off-road vehicles. {{/GA}}{{SC}}In South Carolina, **S.C. Code § 50-26-10 et seq.** is the **2011 Chandler Saylor Law**, which requires safety certificates for riders under 16 and prohibits passengers on single-rider ATVs. {{/SC}}Liability theories include operator negligence, **product liability** (rollover defects, lack of doors/nets — see CPSC ROV recalls), premises liability against landowners (recreational-use immunity often applies), and parental-supervision claims for minor operators. Filing deadline: {sol_years} years under {sol_cite}.
EOT
,
        'compensation' => <<<'EOT'
**Catastrophic-injury patterns dominate** ATV cases — rollover crush, ejection TBI, and limb amputation are common. **Recreational-use statutes sharply limit landowner liability**: {{GA}}Georgia's **Recreational Property Act (O.C.G.A. § 51-3-20 to -26)** bars {{/GA}}{{SC}}South Carolina's **Recreational Use Statute (S.C. Code § 27-3-10 et seq.)** bars {{/SC}}most claims against landowners who allow free recreational use of their property. **Product-liability theories against manufacturers** (Polaris, Yamaha, Honda, Can-Am) often offer the strongest recovery path — manufacturer liability is governed by {{GA}}O.C.G.A. § 51-1-11{{/GA}}{{SC}}S.C. Code § 15-73-10{{/SC}}, with CPSC ROV standards (16 C.F.R. Part 1420) supporting negligence per se.
EOT
,
    ),
