<?php
/**
 * Seeder: boating-accident-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /boating-accident-lawyers/charleston-sc/
 ...
 * harbor/coastal context, and SC boating-law nuances.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-boating-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching boating-accident-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents people injured in boating accidents in Charleston, South Carolina</strong> and throughout the Lowcountry — Mount Pleasant, Sullivan's Island, Isle of Palms, Summerville, and Goose Creek. Charleston Harbor, the Cooper and Ashley rivers, and the surrounding coastal waters see heavy recreational traffic, and a boating crash can cause serious injuries far from immediate help. We handle every claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston Boating Accident Claim</h2>
<p>Boating cases are different from car crashes: there are no lane markings, no traffic cameras, and often no independent witnesses, so proving how the crash happened takes fast investigation. What separates Roden Law is moving quickly to secure the S.C. Department of Natural Resources incident report, locate witnesses, and preserve evidence before it disappears. Our office at 127 King Street sits in downtown Charleston, minutes from the harbor and the Charleston County Circuit Court.</p>
<ul>
...
<h2>How Charleston Boating Accidents Happen</h2>
<p>South Carolina consistently ranks among the states with the most boating incidents, and the Charleston-area cases our attorneys handle most involve:</p>
<ul>
<li><strong>Operator inattention and inexperience</strong> — the most common causes of recreational boat crashes.</li>
<li><strong>Excessive speed</strong> in crowded harbor and inlet areas.</li>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Boating Accident Lawyers in Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'Who regulates boating in South Carolina?',
		'answer'   => 'Recreational boating in South Carolina is regulated by the S.C. Department of Natural Resources under S.C. Code Title 50, Chapter 21. DNR officers investigate serious boating accidents, and the DNR incident report is often key evidence in a boating injury claim.',
	),
	array(
	...
	array(
		'question' => 'How much does a Charleston boating accident lawyer cost?',
		'answer'   => 'Roden Law handles Charleston boating accident cases on a contingency fee basis. You pay no attorney fees and no upfront costs, and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /boating-accident-lawyers/charleston-sc/ — post ID {$post_id}" );
