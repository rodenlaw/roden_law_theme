<?php
/**
 * Seeder: medical-malpractice-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing (thin templated stub) /medical-malpractice-lawyers/
 * charleston-sc/ page in place with rich, practice-specific, hyperlocal body
 * content + FAQPage meta + attorney attribution. Part of P2 row-9 BATCH 3.
 *
 ...
 * answer-first intro, "why Roden Law", local hospitals/context, and med-mal-
 * specific SC nuances (Notice of Intent, expert affidavit, damage cap) — no dup.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-medmal-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching medical-malpractice-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents patients harmed by medical negligence in Charleston, South Carolina and throughout the Lowcountry</strong> — Mount Pleasant, Summerville, Goose Creek, and the peninsula. We handle every medical malpractice claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston Medical Malpractice Claim</h2>
...
<li><strong>Trial-ready</strong> — we prepare every claim for the Charleston County Circuit Court, which is what moves hospital insurers to pay full value.</li>
</ul>

<h2>Charleston Medical Malpractice Cases We Handle</h2>
<p>Charleston is a regional medical hub, and the cases our attorneys see most often arise at its largest institutions and surgical centers:</p>
<ul>
<li><strong>Surgical errors and anesthesia mistakes</strong> at MUSC Health, Roper Hospital, and Trident and East Cooper medical centers.</li>
...
<li><strong>Medication and pharmacy errors</strong> — wrong drug, wrong dose, or dangerous interactions.</li>
<li><strong>ER and hospital negligence</strong> — failure to monitor, retained surgical objects, and hospital-acquired infections.</li>
</ul>

<h2>South Carolina Medical Malpractice Law: What Charleston Patients Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Medical Malpractice Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best medical malpractice lawyers in Charleston, SC?',
		'answer'   => 'Roden Law is a leading medical malpractice firm serving Charleston and the Lowcountry, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our Charleston office at 127 King Street handles every case on a contingency fee basis — no fee unless we win — and retains medical experts from the outset. Call (843) 790-8999 for a free consultation.',
	),
	array(
	...
	array(
		'question' => 'Do I need an expert before suing for malpractice in Charleston?',
	...
	array(
		'question' => 'How much does a Charleston medical malpractice lawyer cost?',
		'answer'   => 'Roden Law handles Charleston medical malpractice cases on a contingency fee basis. You pay no attorney fees and no upfront costs — including the cost of the medical experts needed to build your case — and we are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
	array(
		'question' => 'What counts as medical malpractice at a Charleston hospital?',
		'answer'   => 'Medical malpractice occurs when a provider fails to meet the accepted standard of care of a reasonably prudent practitioner in the same specialty, and that failure causes harm. Common examples at Charleston institutions such as MUSC, Roper, and Trident include surgical errors, misdiagnosis, birth injuries, medication mistakes, and hospital-acquired infections.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /medical-malpractice-lawyers/charleston-sc/ — post ID {$post_id}" );
