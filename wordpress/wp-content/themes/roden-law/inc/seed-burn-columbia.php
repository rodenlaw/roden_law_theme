<?php
/**
 * Seeder: burn-injury-lawyers × Columbia, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /burn-injury-lawyers/columbia-sc/ in place with
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-burn-columbia.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching burn-injury-lawyers × Columbia, SC...' );
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Burn Injury Lawyers in Columbia, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best burn injury lawyers in Columbia, SC?',
	...
	array(
		'question' => 'What if my burn happened at work in Columbia?',
...
WP_CLI::success( "Enriched /burn-injury-lawyers/columbia-sc/ — post ID {$post_id}" );
