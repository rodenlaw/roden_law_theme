<?php
/**
 * Seeder: wrongful-death-lawyers × Myrtle Beach, SC intersection (ENRICH)
 *
 * UPDATES the existing /wrongful-death-lawyers/myrtle-beach-sc/ page in place
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-wrongful-death-myrtle-beach.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching wrongful-death-lawyers × Myrtle Beach, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents families who have lost a loved one to another's negligence in Myrtle Beach, South Carolina and throughout the Grand Strand</strong> — Murrells Inlet, Conway, Surfside Beach, Pawleys Island, and Georgetown. We handle every wrongful death claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients and grieving families across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18436121980">(843) 612-1980</a> for a free, confidential and compassionate case review.</p>

<h2>Why Choose Roden Law for a Myrtle Beach Wrongful Death Claim</h2>
<p>Losing a family member to a preventable death is devastating, and the last thing you should have to fight is an insurance company. What separates Roden Law is direct attorney involvement and the resources to fully investigate how and why your loved one died — from crash reconstruction to hospital records. We serve the Grand Strand from Murrells Inlet through Georgetown, and Horry County claims are filed at the courthouse in Conway — so the estate's claim is handled locally and without delay.</p>
<ul>
...
<h2>Grand Strand Wrongful Death Cases We Handle</h2>
<p>Fatal-injury claims along the Grand Strand most often arise from:</p>
<ul>
<li><strong>Fatal traffic and truck crashes</strong> on US-17 (Kings Highway and the Bypass) and SC-31 (Carolina Bays Parkway).</li>
<li><strong>Pedestrian and bicycle fatalities</strong>, a heightened risk in a walkable tourism corridor with heavy seasonal traffic.</li>
<li><strong>Drowning, boating, and watercraft deaths</strong> along the coast and waterways.</li>
<li><strong>Medical negligence deaths</strong> at Grand Strand Medical Center and area hospitals.</li>
<li><strong>Premises and hospitality-related deaths</strong> at hotels, resorts, and attractions.</li>
</ul>

<h2>South Carolina Wrongful Death Law: What Grand Strand Families Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Wrongful Death Lawyers in Myrtle Beach, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best wrongful death lawyers in Myrtle Beach, SC?',
		'answer'   => 'Roden Law is a leading wrongful death firm serving Myrtle Beach and the Grand Strand, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients and grieving families across Georgia and South Carolina. We handle every case on a contingency fee basis — no fee unless we win. Call (843) 612-1980 for a free, compassionate consultation.',
	),
	array(
	...
	array(
		'question' => 'How much does a Myrtle Beach wrongful death lawyer cost?',
		'answer'   => 'Roden Law handles Grand Strand wrongful death cases on a contingency fee basis. You pay no attorney fees and no upfront costs — we advance the cost of investigation and are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /wrongful-death-lawyers/myrtle-beach-sc/ — post ID {$post_id}" );
