<?php
/**
 * Seeder: dog-bite-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing templated stub /dog-bite-lawyers/charleston-sc/ in place with
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-dogbite-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching dog-bite-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents dog-bite and animal-attack victims across Charleston, South Carolina</strong> and the Lowcountry — Mount Pleasant, Summerville, and Goose Creek. South Carolina is a <strong>strict-liability state</strong>: a dog owner is liable for a bite or attack even if the dog never showed aggression before. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston Dog Bite Claim</h2>
<p>Most dog-bite recoveries come from the owner's homeowner's or renter's insurance, and adjusters routinely argue the victim provoked the animal or was somewhere they should not have been. What separates Roden Law is direct attorney involvement and the investigation needed to defeat those defenses. Our office at 127 King Street, Suite 200 sits on the peninsula, minutes from the Charleston County Circuit Court.</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Dog Bite Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best dog bite lawyers in Charleston, SC?',
	...
	array(
		...
		'answer'   => 'In most cases the dog owner\'s homeowner\'s or renter\'s insurance provides the recovery. Roden Law investigates ownership and identifies every applicable policy, which is often the most important step in a Charleston dog-attack case, especially with rental and short-term-rental properties.',
	),
	array(
...
WP_CLI::success( "Enriched /dog-bite-lawyers/charleston-sc/ — post ID {$post_id}" );
