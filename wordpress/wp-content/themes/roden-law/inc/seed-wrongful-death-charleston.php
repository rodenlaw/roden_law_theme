<?php
/**
 * Seeder: wrongful-death-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing /wrongful-death-lawyers/charleston-sc/ page in place with
 ...
 * context, and wrongful-death SC nuances (PR, survival action, beneficiaries) —
 * no duplication.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-wrongful-death-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching wrongful-death-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents families who have lost a loved one to another's negligence in Charleston, South Carolina and throughout the Lowcountry</strong> — Mount Pleasant, Summerville, Goose Creek, and the peninsula. We handle every wrongful death claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients and grieving families across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential and compassionate case review.</p>

<h2>Why Choose Roden Law for a Charleston Wrongful Death Claim</h2>
<p>Losing a family member to a preventable death is devastating, and the last thing you should have to fight is an insurance company. What separates Roden Law is direct attorney involvement and the resources to fully investigate how and why your loved one died — from crash reconstruction to hospital records. Our office at 127 King Street sits on the Charleston peninsula, minutes from the Charleston County Circuit Court, so the estate's claim is handled locally and without delay.</p>
<ul>
...
<h2>Charleston Wrongful Death Cases We Handle</h2>
<p>Fatal-injury claims in the Lowcountry most often arise from:</p>
<ul>
<li><strong>Fatal traffic and truck crashes</strong> on I-526, the Ravenel Bridge, US-17, and I-26.</li>
<li><strong>Pedestrian and bicycle fatalities</strong> on the peninsula and busy Mount Pleasant corridors.</li>
<li><strong>Medical negligence deaths</strong> at area hospitals and surgical centers.</li>
<li><strong>Workplace and construction fatalities</strong>, including port and industrial incidents.</li>
<li><strong>Drowning, boating, and premises-related deaths</strong> in a coastal region with heavy tourism.</li>
</ul>

<h2>South Carolina Wrongful Death Law: What Charleston Families Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Wrongful Death Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best wrongful death lawyers in Charleston, SC?',
		'answer'   => 'Roden Law is a leading wrongful death firm serving Charleston and the Lowcountry, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients and grieving families across Georgia and South Carolina. Our Charleston office at 127 King Street handles every case on a contingency fee basis — no fee unless we win. Call (843) 790-8999 for a free, compassionate consultation.',
	),
	array(
	...
	array(
		'question' => 'How much does a Charleston wrongful death lawyer cost?',
		'answer'   => 'Roden Law handles Charleston wrongful death cases on a contingency fee basis. You pay no attorney fees and no upfront costs — we advance the cost of investigation and are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /wrongful-death-lawyers/charleston-sc/ — post ID {$post_id}" );
