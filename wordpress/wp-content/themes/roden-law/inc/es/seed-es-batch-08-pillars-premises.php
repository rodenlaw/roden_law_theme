...
HTML,
        'meta'    => array(
            ...
            '_roden_common_injuries'  => array( 'Fracturas de cadera, muñeca y tobillo', 'Lesiones de espalda y hernias de disco', 'Lesiones cerebrales traumáticas por golpes en la cabeza', 'Lesiones de hombro y desgarres de ligamentos', 'Lesiones de rodilla', 'Cortes y contusiones graves' ),
            '_roden_faqs'             => array(
...
HTML,
        'meta'    => array(
            ...
            '_roden_common_injuries'  => array( 'Heridas punzantes y desgarros profundos', 'Cicatrices permanentes y desfiguración facial', 'Infecciones graves', 'Daño a nervios, tendones y músculos', 'Fracturas por caídas durante el ataque', 'Trauma emocional y estrés postraumático, especialmente en niños' ),
            '_roden_faqs'             => array(
