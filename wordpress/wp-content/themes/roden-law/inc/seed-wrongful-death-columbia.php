<?php
/**
 * Seeder: wrongful-death-lawyers × Columbia, SC intersection page (ENRICH)
 *
 * UPDATES the existing /wrongful-death-lawyers/columbia-sc/ page in place with
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-wrongful-death-columbia.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching wrongful-death-lawyers × Columbia, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents families who have lost a loved one to another's negligence in Columbia, South Carolina and throughout the Midlands</strong> — Lexington, Irmo, West Columbia, Cayce, and Forest Acres. We handle every wrongful death claim on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients and grieving families across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Call <a href="tel:+18032192816">(803) 219-2816</a> for a free, confidential and compassionate case review.</p>

<h2>Why Choose Roden Law for a Columbia Wrongful Death Claim</h2>
<p>Losing a family member to a preventable death is devastating, and the last thing you should have to fight is an insurance company. What separates Roden Law is direct attorney involvement and the resources to fully investigate how and why your loved one died — from crash reconstruction to hospital records. Our office at 1545 Sumter Street, Suite B sits in the downtown corridor minutes from the Richland County Circuit Court, so the estate's claim is handled locally and without delay.</p>
<ul>
...
<li><strong>Trial-ready</strong> — we prepare every claim for the Richland County Circuit Court, which is what moves insurers to pay full value.</li>
</ul>

<h2>Columbia Wrongful Death Cases We Handle</h2>
<p>Fatal-injury claims in the Midlands most often arise from:</p>
<ul>
<li><strong>Fatal traffic and truck crashes</strong> on the I-20/I-26/I-77 "Malfunction Junction" interchange and the surrounding interstate corridors.</li>
<li><strong>DUI and high-speed crash fatalities</strong>, including in the USC and Five Points area.</li>
<li><strong>Medical negligence deaths</strong> at Prisma Health Richland and area hospitals.</li>
<li><strong>Workplace and construction fatalities</strong> on Midlands job sites and roadwork projects.</li>
<li><strong>Pedestrian and premises-related deaths</strong> caused by negligent drivers or unsafe property.</li>
</ul>

<h2>South Carolina Wrongful Death Law: What Columbia Families Need to Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Wrongful Death Lawyers in Columbia, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best wrongful death lawyers in Columbia, SC?',
		'answer'   => 'Roden Law is a leading wrongful death firm serving Columbia and the Midlands, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients and grieving families across Georgia and South Carolina. Our Columbia office at 1545 Sumter Street handles every case on a contingency fee basis — no fee unless we win. Call (803) 219-2816 for a free, compassionate consultation.',
	),
	array(
	...
	array(
		'question' => 'How much does a Columbia wrongful death lawyer cost?',
		'answer'   => 'Roden Law handles Columbia wrongful death cases on a contingency fee basis. You pay no attorney fees and no upfront costs — we advance the cost of investigation and are only paid a percentage of the recovery if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /wrongful-death-lawyers/columbia-sc/ — post ID {$post_id}" );
