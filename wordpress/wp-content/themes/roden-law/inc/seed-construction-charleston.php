<?php
/**
 * Seeder: construction-accident-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /construction-accident-lawyers/charleston-sc/
 ...
 * industry context, and the comp-vs-third-party construction-injury nuances.
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-construction-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching construction-accident-lawyers × Charleston, SC...' );
...
<h2>Charleston Construction Hazards We Handle</h2>
<p>Heavy commercial construction around the Charleston port, and residential and commercial development across the Lowcountry, drive the "fatal four" hazards our attorneys see most:</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Construction Accident Lawyers in Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'How much does a Charleston construction accident lawyer cost?',
		'answer'   => 'Roden Law handles Charleston construction accident cases on a contingency fee basis. You pay no attorney fees and no upfront costs, and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /construction-accident-lawyers/charleston-sc/ — post ID {$post_id}" );
