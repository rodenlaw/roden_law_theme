<?php
/**
 * Seeder: motorcycle-accident-lawyers × Charleston, SC intersection page (ENRICH)
 *
 ...
 * first intro, "why Roden Law", local risk roads (bridge, peninsula, I-526), and
 * motorcycle-specific SC nuances (helmet law, rider bias, UM/UIM stacking).
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-moto-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching motorcycle-accident-lawyers × Charleston, SC...' );
...
$content = <<<'HTML'
<p><strong>Roden Law represents motorcyclists injured in crashes across Charleston and the Lowcountry</strong> — Mount Pleasant, West Ashley, James Island, Johns Island, and Daniel Island. Riders face devastating injuries and an uphill fight against insurers and jurors biased against motorcyclists — a bias our attorneys are built to overcome. We handle every case on a <strong>contingency fee basis: you pay nothing unless we win</strong>. Roden Law has recovered <strong>more than $300 million</strong> for injured clients across Georgia and South Carolina and holds a <strong>4.9-star average from hundreds of client reviews</strong>. Our downtown office is at 127 King Street, Suite 200. Call <a href="tel:+18437908999">(843) 790-8999</a> for a free, confidential case review.</p>

<h2>Why Choose Roden Law for a Charleston Motorcycle Accident Claim</h2>
...
<p>The Lowcountry crashes our attorneys handle most often involve:</p>
<ul>
<li><strong>Bridge and crosstown crashes</strong> on the Arthur Ravenel Jr. Bridge and the US-17 Crosstown (Septima P. Clark Parkway), where high speeds and lane changes meet vulnerable riders.</li>
<li><strong>Left-turn collisions</strong> — a car turning across a rider's path is the most common and most catastrophic motorcycle crash, and the dense peninsula and Savannah Highway (US-17) corridors see them constantly.</li>
<li><strong>Interstate merge crashes</strong> on I-26 and I-526, including the high-crash I-26/I-526 interchange.</li>
<li><strong>Tourist-district crashes</strong> around King and Market Street, where out-of-state drivers and rideshare traffic fail to see riders.</li>
</ul>

<h2>South Carolina Motorcycle Law: What Charleston Riders Should Know</h2>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Motorcycle Accident Lawyers in Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'What are the most dangerous roads for motorcyclists in Charleston?',
		'answer'   => 'The Arthur Ravenel Jr. Bridge, the US-17 Crosstown (Septima P. Clark Parkway), and the I-26/I-526 interchange are especially hazardous for riders. Left-turn crashes on the dense peninsula and Savannah Highway (US-17), and tourist-district traffic around King and Market Street, are also frequent.',
	),
	array(
...
WP_CLI::success( "Enriched /motorcycle-accident-lawyers/charleston-sc/ — post ID {$post_id}" );
