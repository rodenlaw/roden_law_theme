<?php
/**
 * Batch Create North Charleston Sub-Neighborhood Pages
 *
 * Run via WP-CLI:
 *   wp eval-file wp-content/themes/roden-law/inc/batch-create-north-charleston-neighborhoods.php
 *
 * Reads from inc/data/north-charleston-neighborhoods.json
 * Creates location CPT posts as children of the North Charleston neighborhood page.
...
if ( ! defined( 'ABSPATH' ) || ! class_exists( 'WP_CLI' ) ) {
    echo "This script must be run via WP-CLI: wp eval-file wp-content/themes/roden-law/inc/batch-create-north-charleston-neighborhoods.php\n";
    exit( 1 );
}

// Load neighborhood data
$data_file = get_template_directory() . '/inc/data/north-charleston-neighborhoods.json';
