...
$faq_templates = array(
    ...
    'bicycle-accident-lawyers' => array(
        ...
        array(
            ...
            'answer'   => 'Yes. In {state_full}, bicyclists have the same rights to the road as motor vehicle drivers. If a driver\'s negligence caused your bicycle accident — whether through distracted driving, failure to yield, dooring, or running a red light — you can file a personal injury claim against them. {state_full} follows a modified comparative fault rule, meaning you can recover damages as long as you are less than {fault_pct}% at fault ({fault_cite}). Even if the driver claims you were partially responsible, an experienced bicycle accident attorney can help demonstrate the full extent of their negligence. Our {city} attorneys have recovered over $300 million for injured clients across Georgia and South Carolina.',
        ),
        array(
