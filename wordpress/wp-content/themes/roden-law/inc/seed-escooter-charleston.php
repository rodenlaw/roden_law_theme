<?php
/**
 * Seeder: electric-scooter-accident-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /electric-scooter-accident-lawyers/charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-escooter-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching electric-scooter-accident-lawyers × Charleston, SC...' );
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Electric Scooter Accident Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best electric scooter accident lawyers in Charleston, SC?',
	...
	array(
		'question' => 'Who pays if a car hits me while I am on a scooter in Charleston?',
	...
	array(
		'question' => 'Are electric scooters legal on Charleston streets and sidewalks?',
		'answer'   => 'Charleston, like many cities, has municipal rules governing where scooters may operate, and those rules continue to evolve. Where you were riding can affect a claim, but it does not automatically bar recovery — the key questions are who was negligent and what caused the crash. Roden Law can review the specific rules that applied to your ride.',
	),
	array(
...
WP_CLI::success( "Enriched /electric-scooter-accident-lawyers/charleston-sc/ — post ID {$post_id}" );
