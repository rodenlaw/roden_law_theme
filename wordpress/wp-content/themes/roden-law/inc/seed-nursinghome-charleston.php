<?php
/**
 * Seeder: nursing-home-abuse-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /nursing-home-abuse-lawyers/charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-nursinghome-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching nursing-home-abuse-lawyers × Charleston, SC...' );
...
<h2>Charleston Nursing Home Harms We Handle</h2>
<p>The Lowcountry's growing senior population fills a large number of long-term-care and assisted-living facilities, and the harms our attorneys see most include:</p>
<ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Nursing Home Abuse Lawyers in Charleston, SC',
...
$faqs = array(
	...
	array(
		'question' => 'How much does a Charleston nursing home abuse lawyer cost?',
		'answer'   => 'Roden Law handles Charleston nursing home abuse and neglect cases on a contingency fee basis. You pay no attorney fees and no upfront costs, and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /nursing-home-abuse-lawyers/charleston-sc/ — post ID {$post_id}" );
