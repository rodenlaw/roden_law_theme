<?php
/**
 * Seeder: spinal-cord-injury-lawyers × Charleston, SC intersection page (ENRICH)
 *
 * UPDATES the existing thin templated stub /spinal-cord-injury-lawyers/charleston-sc/
 ...
 *
 * Usage:
 *   wp eval-file wp-content/themes/roden-law/inc/seed-spinal-charleston.php
 * Safe to re-run: updates the existing page in place (does NOT create a new one).
 */

defined( 'ABSPATH' ) || exit;

WP_CLI::log( 'Enriching spinal-cord-injury-lawyers × Charleston, SC...' );
...
<h2>How Charleston Spinal Cord Injuries Happen</h2>
<p>The Lowcountry's traffic, water, and worksites drive the catastrophic-injury cases our attorneys see most:</p>
<ul>
<li><strong>Highway crashes</strong> on I-526, I-26, and the Arthur Ravenel Jr. Bridge, where high-speed impacts and truck collisions cause the most severe spinal trauma.</li>
<li><strong>Falls</strong> — from heights on construction sites, in apartment complexes, and on unsafe property.</li>
<li><strong>Diving and boating injuries</strong> in the Charleston Harbor, tidal creeks, and area waterways.</li>
<li><strong>Workplace and dock injuries</strong> at the port, industrial sites, and warehouses.</li>
</ul>
...
$postarr = array(
	'post_type'    => 'practice_area',
	'post_status'  => 'publish',
	'post_title'   => 'Spinal Cord Injury Lawyers in Charleston, SC',
...
$faqs = array(
	array(
		'question' => 'Who are the best spinal cord injury lawyers in Charleston, SC?',
		'answer'   => 'Roden Law is a leading catastrophic-injury firm serving Charleston and the Lowcountry, with a 4.9-star average from hundreds of client reviews and more than $300 million recovered for injured clients across Georgia and South Carolina. Our Charleston office at 127 King Street handles every case on a contingency fee basis — no fee unless we win — and retains life-care planners and economists to prove full value. Call (843) 790-8999 for a free consultation.',
	),
	array(
		'question' => 'How much is a Charleston spinal cord injury case worth?',
	...
	array(
		'question' => 'What if my spinal cord injury happened at work in Charleston?',
	...
	array(
		'question' => 'How much does a Charleston spinal cord injury lawyer cost?',
		'answer'   => 'Roden Law handles Charleston spinal cord injury cases on a contingency fee basis. You pay no attorney fees and no upfront costs — including the cost of the medical and life-care experts needed to build your case — and we are only paid if we win. If there is no recovery, you owe us nothing.',
	),
);
update_post_meta( $post_id, '_roden_faqs', $faqs );

WP_CLI::success( "Enriched /spinal-cord-injury-lawyers/charleston-sc/ — post ID {$post_id}" );
