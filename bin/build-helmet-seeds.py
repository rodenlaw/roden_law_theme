...
def build(slug, atty_id, atty_name, juris):
    md=open(f'data/practice-area-drafts/2026-09/{slug}.md').read()
    fm,body=md.split('\n---\n',1)
...
build('georgia-helmet-laws',3729,'Eric Roden','georgia-only')
build('south-carolina-helmet-laws',3732,'Graeham C. Gillin','south-carolina-only')
