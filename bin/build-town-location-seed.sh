...
#
#   bin/build-town-location-seed.sh                 # dry run
#   bin/build-town-location-seed.sh apply           # create drafts
#   bin/build-town-location-seed.sh apply publish   # publish (needs FAQs on every page)
#
set -euo pipefail
...
JSON="${SEED_JSON:-$repo/data/sc-town-locations-2026-08-20.json}"
SEEDER="$here/seed-sc-town-locations.php"
...
tmp_base="$(mktemp -t town-location-seed)"
tmp="$tmp_base.php"
