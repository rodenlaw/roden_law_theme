...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: "keyTakeaways", title: "Key Takeaways", type: "text", description: "Plain-text summary for AI citation / meta description" }),
    defineField({
      name: "keyTakeawaysRich",
      title: "Key Takeaways (rich)",
      type: "array",
      of: [{ type: "block" }],
      description: "Display version with bold emphasis. keyTakeaways (plain) stays the machine-readable copy.",
    }),
