<?php
/**
 * Batch Create Savannah Sub-Neighborhood Pages
 *
 * Run via WP-CLI:
 *   wp eval-file wp-content/themes/roden-law/inc/batch-create-savannah-sub-neighborhoods.php
 *
 * @package RodenLaw
 */

if ( ! defined( 'ABSPATH' ) || ! class_exists( 'WP_CLI' ) ) {
    echo "This script must be run via WP-CLI: wp eval-file wp-content/themes/roden-law/inc/batch-create-savannah-sub-neighborhoods.php\n";
    exit( 1 );
}

$data_file = get_template_directory() . '/inc/data/savannah-sub-neighborhoods.json';
