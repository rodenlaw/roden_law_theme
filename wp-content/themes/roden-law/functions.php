...
function roden_remove_es_sitemap_index_entry( $sitemap_entry ) {
    if ( isset( $sitemap_entry['loc'] ) && false !== strpos( $sitemap_entry['loc'], '/es/wp-sitemap' ) ) {
        return array();
    }
...
/* ==========================================================================
   ...
   ========================================================================== */
// Removed: duplicate meta description was output here AND in seo-meta.php.
// The seo-meta.php version uses firm_data() and is preferred.
