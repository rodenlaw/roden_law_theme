...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" aria-label="<?php esc_attr_e( 'Site search', 'roden-law' ); ?>">
    ...
    <input type="search" id="search-field" class="search-field" placeholder="<?php esc_attr_e( "Search articles (e.g. 'truck accident')", 'roden-law' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" />
