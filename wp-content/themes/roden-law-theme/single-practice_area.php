                ...
                <div class="nap-block">
                    ...
                    <div class="nap-details">
                        <div class="nap-col">
                            ...
                            <span>
                                <span><?php echo esc_html( $office['city'] ); ?></span>,
                                <span><?php echo esc_html( $office['state'] ); ?></span>
                                <span><?php echo esc_html( $office['zip'] ); ?></span>
                            </span>
                        </div>
                        <div class="nap-col">
                            <span class="nap-label">Phone</span>
                            <a href="tel:<?php echo esc_attr($office['phone_e164']); ?>" class="nap-phone"><?php echo esc_html( $office['phone'] ); ?></a>
...
<!-- OTHER LOCATIONS FOR THIS PRACTICE AREA -->
    ...
    <div class="container">
        ...
        <div class="location-matrix-grid">
            <?php foreach ( $firm['offices'] as $key => $o ) :
                $city_slug = strtolower( str_replace(' ', '-', $o['city'] ) ) . '-' . strtolower( $o['state'] );
                $is_current = ( $key === $pa_office_key );
                // Find intersection page for this office
            ...
            ?>
                <div class="matrix-card <?php echo $is_current ? 'matrix-card-active' : ''; ?>">
                    <span class="matrix-state state-<?php echo esc_attr(strtolower($o['state'])); ?>"><?php echo esc_html($o['state']); ?></span>
...
<div class="content-with-sidebar">
    <div class="container content-sidebar-grid">
        <article class="main-content">
            ...
            <!-- State Law Box (single state only) -->
            ...
            <div class="bottom-cta-box">
                ...
                <p>If you were injured in <?php echo esc_html($office['city']); ?> and believe another party is at fault, contact us for a free, no-obligation review. Call <?php echo esc_html($office['phone']); ?> — no upfront cost.</p>
                <div class="cta-actions">
                    <a href="tel:<?php echo esc_attr($office['phone_e164']); ?>" class="btn btn-primary">📞 Call <?php echo esc_html($office['phone']); ?></a>
        ...
        <aside class="sidebar sidebar-practice">
            <div class="sidebar-sticky">
                ...
                <div class="sidebar-widget sidebar-deadlines">
                    <h3 class="widget-title">⏱ <?php echo esc_html($office['state_full']); ?> Filing Deadline</h3>
                    <div class="deadline-badges">
                        <div class="deadline-badge <?php echo $office['state'] === 'GA' ? 'deadline-ga' : 'deadline-sc'; ?>" style="flex:1;">
                            <span class="deadline-years"><?php echo $office['state'] === 'GA' ? '2 yr' : '3 yr'; ?></span>
                            <span class="deadline-state"><?php echo esc_html($office['state_full']); ?></span>
                        </div>
                    </div>
